...
\chapter{Development of an Astrocyte Plasticity Model that Generalizes STDP} \label{chapter:astro_plasticity_modeal}
    ...
    \asvgf{figures/artifacts/obj1/sweep-alpha_tau-ip3-spike0.100.svg}{Model Response to
      Sweeping Input pathway $\alpha$, and
      $\tau_u$}{fig:astro:sweep_alpha_ip3_tau_1}{}

    \asvgf{figures/artifacts/obj1/sweep-alpha_tau-ip3-spike0.440.svg}{Model Response to
      Sweeping Input pathway $\alpha$, and
      $\tau_{ip3}$}{fig:astro:sweep_alpha_ip3_tau_2}{}
    ...
    \asvgf{figures/artifacts/obj1/sweep_u_tau_0.100.svg}{Response of $u$ to
      Poisson Distributed spikes applied to Pre and Post-Synaptic
      Pathways}{fig:astro:sweep_alpha_u_tau_1}{}

    \asvgf{figures/artifacts/obj1/sweep_u_tau_0.500.svg}{Response of $u$ to
      Poisson Distributed spikes applied to Pre and Post-Synaptic
      Pathways}{fig:astro:sweep_alpha_u_tau_2}{}
    ...
    \asvgf{figures/artifacts/obj1/snn_1n1s1a_rp_no-band_0.svg}{APM Response to
      Poisson Input With $thr_{ltp}=thr_{ltd}=0.0$}{fig:rate:lif_net_1}{}
    
    \asvgf{figures/artifacts/obj1/snn_1n1s1a_rp_band_0.svg}{APM response to
      Possion Input With $thr_{ltp}=1.5,
      thr_{ltd}=-1.5$}{fig:astro:classic_stdp}{}
