...
\chapter{Development of an Astrocyte Plasticity Model that Generalizes STDP} \label{chapter:astro_plasticity_modeal}
    ...
    %% \asvgf{figures/artifacts/obj1/sweep-alpha_tau-ip3-spike0.280.svg}{Model Response to
    ...
    %% \asvgf{figures/artifacts/obj1/snn_1n1s1a_stdp_u_thr-2.5_0.svg}{Simulation of
    %% Neuron-Astrocyte Model In 1S1N1A Configuration With Spike Pulses as
    %% Inputs}{fig:astro:1n1s1a_impulse}{}
